...
import 'package:condotoo/Screens/Restaurant/components/coffee_details.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap:() => Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => CoffeeDetails(index: index,)),
      ),
      child: Container(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: new LinearGradient(
                      colors: [
                        Colors.black12, coffee_list[index].backgroundColor,
                      ],
