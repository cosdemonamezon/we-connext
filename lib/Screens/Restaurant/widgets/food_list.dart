              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(food.title, style: TextStyle(color: Colors.black, fontSize: 12.0)),
                  ),
                  SizedBox(height: 5.0,),
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text(food.rating, style: TextStyle(fontSize: 9.0, color: Colors.black38)),
                            SizedBox(width: 5.0,),
                            ...
                            SizedBox(width: 5.0,),
                            Text("(200)", style: TextStyle(fontSize: 9.0, color: Colors.black38)),
                          ],
                        ),
                        Text(
                          "\$" + food.price, 
